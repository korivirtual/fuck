...
from aime.data import Config, Data, cached
...
class CxbRev(CxbBase):
    ...
    def handle_data_putlog_request(self, data: Dict) -> Dict:
        if data["putlog"]["type"] == "ResultLog":
            bdata = json.loads(data["putlog"]["data"])
            score_data = json.loads(data["putlog"]["data"])
            print(f"{bdata} - {score_data}")
            return({"data":True})
        return {"data": True }
    ...
    def handle_data_music_list_request(self, data: Dict) -> Dict:
        ret_str = ""
        with open(r"aime/titles/cxb/rev_data/MusicArchiveList.csv") as music:
    ...
    def handle_data_item_list_icon_request(self, data: Dict) -> Dict:
        ret_str = "\r\n#ItemListIcon\r\n"
        with open(r"aime/titles/cxb/rev_data/Item/ItemArchiveList_Icon.csv", encoding="utf-8") as item:
    ...
    def handle_data_item_list_skin_notes_request(self, data: Dict) -> Dict:
        ret_str = "\r\n#ItemListSkinNotes\r\n"
        with open(r"aime/titles/cxb/rev_data/Item/ItemArchiveList_SkinNotes.csv", encoding="utf-8") as item:
            lines = item.readlines()
            for line in lines:
                ret_str += f"{line[:-1]}\r\n"
        return({"data":ret_str})
    ...
    def handle_data_item_list_skin_effect_request(self, data: Dict) -> Dict:
        ret_str = "\r\n#ItemListSkinEffect\r\n"
        with open(r"aime/titles/cxb/rev_data/Item/ItemArchiveList_SkinEffect.csv", encoding="utf-8") as item:
            lines = item.readlines()
            for line in lines:
                ret_str += f"{line[:-1]}\r\n"
        return({"data":ret_str})
    ...
    def handle_data_item_list_skin_bg_request(self, data: Dict) -> Dict:
        ret_str = "\r\n#ItemListSkinBg\r\n"
        with open(r"aime/titles/cxb/rev_data/Item/ItemArchiveList_SkinBg.csv", encoding="utf-8") as item:
            lines = item.readlines()
            for line in lines:
                ret_str += f"{line[:-1]}\r\n"
        return({"data":ret_str})
    ...
    def handle_data_item_list_title_request(self, data: Dict) -> Dict:
        ret_str = "\r\n#ItemListTitle\r\n"
        with open(r"aime/titles/cxb/rev_data/Item/ItemList_Title.csv", encoding="shift-jis") as item:
            lines = item.readlines()
            for line in lines:
                ret_str += f"{line[:-1]}\r\n"
        return({"data":ret_str})
    ...
    def handle_data_shop_list_music_request(self, data: Dict) -> Dict:
        ret_str = "\r\n#ShopListMusic\r\n"
        with open(r"aime/titles/cxb/rev_data/Shop/ShopList_Music.csv", encoding="shift-jis") as shop:
    ...
    def handle_data_shop_list_icon_request(self, data: Dict) -> Dict:
        ret_str = "\r\n#ShopListIcon\r\n"
        with open(r"aime/titles/cxb/rev_data/Shop/ShopList_Icon.csv", encoding="shift-jis") as shop:
            lines = shop.readlines()
            for line in lines:
                ret_str += f"{line[:-1]}\r\n"
        return({"data":ret_str})
    ...
    def handle_data_shop_list_title_request(self, data: Dict) -> Dict:
        ret_str = "\r\n#ShopListTitle\r\n"
        with open(r"aime/titles/cxb/rev_data/Shop/ShopList_Title.csv", encoding="shift-jis") as shop:
            lines = shop.readlines()
            for line in lines:
                ret_str += f"{line[:-1]}\r\n"
        return({"data":ret_str})
    ...
    def handle_data_shop_list_sale_request(self, data: Dict) -> Dict:
        ret_str = "\r\n#ShopListSale\r\n"
        with open(r"aime/titles/cxb/rev_data/Shop/ShopList_Sale.csv", encoding="shift-jis") as shop:
            lines = shop.readlines()
            for line in lines:
                ret_str += f"{line[:-1]}\r\n"
        return({"data":ret_str})
    ...
    def handle_data_extra_stage_list_request(self, data: Dict) -> Dict:
        ret_str = ""
        with open(r"aime/titles/cxb/rev_data/ExtraStageList.csv", encoding="shift-jis") as stage:
    ...
    def handle_data_exxxxx_request(self, data: Dict) -> Dict:
        ...
        ret_str = ""
        with open(fr"aime/titles/cxb/rev_data/Ex000{extra_num}.csv", encoding="shift-jis") as stage:
            lines = stage.readlines()
            for line in lines:
                ret_str += f"{line[:-1]}\r\n"
        return({"data":ret_str})
    ...
    def handle_data_news_list_request(self, data: Dict) -> Dict:
        ret_str = ""
        with open(r"aime/titles/cxb/rev_data/NewsList.csv", encoding="UTF-8") as news:
    ...
    def handle_data_license_request(self, data: Dict) -> Dict:
        ret_str = ""
        with open(r"aime/titles/cxb/rev_data/License_Offline.csv", encoding="UTF-8") as lic:
            lines = lic.readlines()
            for line in lines:
                ret_str += f"{line[:-1]}\r\n"
        return({"data":ret_str})
    ...
    def handle_data_course_list_request(self, data: Dict) -> Dict:
        ret_str = ""
        with open(r"aime/titles/cxb/rev_data/Course/CourseList.csv", encoding="UTF-8") as course:
    ...
    def handle_data_csxxxx_request(self, data: Dict) -> Dict:
        ...
        extra_num = int(data["dldate"]["filetype"][-4:])
        ret_str = ""
        with open(fr"aime/titles/cxb/rev_data/Course/Cs000{extra_num}.csv", encoding="shift-jis") as course:
            lines = course.readlines()
            for line in lines:
                ret_str += f"{line[:-1]}\r\n"
        return({"data":ret_str})
    ...
    def handle_data_mission_list_request(self, data: Dict) -> Dict:
        ret_str = ""
        with open(r"aime/titles/cxb/rev_data/MissionList.csv", encoding="shift-jis") as mission:
    ...
    def handle_data_event_list_request(self, data: Dict) -> Dict:
        ret_str = ""
        with open(r"aime/titles/cxb/rev_data/Event/EventArchiveList.csv", encoding="shift-jis") as mission:
            lines = mission.readlines()
            for line in lines:
                ret_str += f"{line[:-1]}\r\n"
        return({"data":ret_str})
    ...
    def handle_data_event_stamp_list_request(self, data: Dict) -> Dict:
        ret_str = ""
        with open(r"aime/titles/cxb/rev_data/Event/EventStampList.csv", encoding="shift-jis") as event:
