...
class CxbRevSunriseS2(CxbBase):
    ...
    def handle_data_music_list_request(self, data: Dict) -> Dict:
        ret_str = ""
        with open(r"aime/titles/cxb/rss2_data/MusicArchiveList.csv") as music:
    ...
    def handle_data_item_list_detail_request(self, data: Dict) -> Dict:
        ...
        with open(r"aime/titles/cxb/rss2_data/Item/ItemList_Icon.csv", encoding="utf-8") as item:
        ...
        #ItemListTitle load
        ret_str += "\r\n#ItemListTitle\r\n"
        with open(r"aime/titles/cxb/rss2_data/Item/ItemList_Title.csv", encoding="utf-8") as item:
            lines = item.readlines()
            for line in lines:
                ret_str += f"{line[:-1]}\r\n"
    ...
    def handle_data_shop_list_detail_request(self, data: Dict) -> Dict:
        ...
        with open(r"aime/titles/cxb/rss2_data/Shop/ShopList_Icon.csv", encoding="utf-8") as shop:
        ...
        #ShopListMusic load
        ret_str += "\r\n#ShopListMusic\r\n"
        with open(r"aime/titles/cxb/rss2_data/Shop/ShopList_Music.csv", encoding="utf-8") as shop:
            lines = shop.readlines()
            for line in lines:
                ret_str += f"{line[:-1]}\r\n"
        ...
        #ShopListSale load
        ret_str += "\r\n#ShopListSale\r\n"
        with open(r"aime/titles/cxb/rss2_data/Shop/ShopList_Sale.csv", encoding="shift-jis") as shop:
            lines = shop.readlines()
            for line in lines:
                ret_str += f"{line[:-1]}\r\n"
        ...
        #ShopListSkinBg load
        ret_str += "\r\n#ShopListSkinBg\r\n"
        with open(r"aime/titles/cxb/rss2_data/Shop/ShopList_SkinBg.csv", encoding="shift-jis") as shop:
            lines = shop.readlines()
            for line in lines:
                ret_str += f"{line[:-1]}\r\n"
        ...
        ret_str += "\r\n#ShopListSkinEffect\r\n"
        with open(r"aime/titles/cxb/rss2_data/Shop/ShopList_SkinEffect.csv", encoding="shift-jis") as shop:
            lines = shop.readlines()
            for line in lines:
                ret_str += f"{line[:-1]}\r\n"
        ...
        ret_str += "\r\n#ShopListSkinNotes\r\n"
        with open(r"aime/titles/cxb/rss2_data/Shop/ShopList_SkinNotes.csv", encoding="shift-jis") as shop:
            lines = shop.readlines()
            for line in lines:
                ret_str += f"{line[:-1]}\r\n"
        ...
        #ShopListTitle load
        ret_str += "\r\n#ShopListTitle\r\n"
        with open(r"aime/titles/cxb/rss2_data/Shop/ShopList_Title.csv", encoding="utf-8") as shop:
            lines = shop.readlines()
            for line in lines:
                ret_str += f"{line[:-1]}\r\n"
        return({"data":ret_str})
    ...
    def handle_data_news_list_request(self, data: Dict) -> Dict:
        ret_str = ""
        with open(r"aime/titles/cxb/rss2_data/NewsList.csv", encoding="UTF-8") as news:
    ...
    def handle_data_license_request(self, data: Dict) -> Dict:
        ret_str = ""
        with open(r"aime/titles/cxb/rss2_data/License.csv", encoding="UTF-8") as licenses:
    ...
    def handle_data_course_list_request(self, data: Dict) -> Dict:
        ret_str = ""
        with open(r"aime/titles/cxb/rss2_data/Course/CourseList.csv", encoding="UTF-8") as course:
    ...
    def handle_data_csxxxx_request(self, data: Dict) -> Dict:
        ...
        ret_str = ""
        with open(fr"aime/titles/cxb/rss2_data/Course/Cs{extra_num}.csv", encoding="shift-jis") as course:
            lines = course.readlines()
            for line in lines:
                ret_str += f"{line[:-1]}\r\n"
        return({"data":ret_str})
    ...
    def handle_data_partnerxxxx_request(self, data: Dict) -> Dict:
        ...
        with open(r"aime/titles/cxb/rss2_data/Partner0000.csv") as partner:
